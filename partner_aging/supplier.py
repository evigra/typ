    ...
    def init(self, cr):
        ...
        query="""
                ...
                SELECT l.id as id, l.partner_id as partner_id, res_partner.name as "partner_name",
                    ...
                    --------------
                    l.credit - l.debit  as "total",
                    CASE WHEN (days_due BETWEEN 01 and 30) THEN l.credit - l.debit ELSE 0 END  AS "days_due_01to30", 
                    CASE WHEN (days_due BETWEEN 31 and 60) THEN l.credit - l.debit ELSE 0 END  AS "days_due_31to60",
                    CASE WHEN (days_due BETWEEN 61 and 90) THEN l.credit - l.debit ELSE 0 END  AS "days_due_61to90", 
                    CASE WHEN (days_due BETWEEN 91 and 120) THEN l.credit - l.debit ELSE 0 END  AS "days_due_91to120",
                    CASE WHEN days_due >= 121 THEN l.credit - l.debit ELSE 0 END AS "days_due_121togr",
                    CASE WHEN days_due <= 0 THEN l.credit - l.debit ELSE 0 END as "current",                    
                    ----------------
                ...
                INNER JOIN         
                  (     
                   ...
                   --ELSE 
                   EXTRACT(DAY FROM (now() - lt.date_maturity)) AS days_due
                   --END AS days_due             
