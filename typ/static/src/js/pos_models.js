odoo.define("typ.models.extend", function (require) {
    ...
    models.Order = models.Order.extend({
        ...
        init_from_JSON: function (json) {
            ...
            if (json.l10n_mx_edi_usage) {
                ...
                this.l10n_mx_edi_usage = this.get_client()
                    ? this.get_client().l10n_mx_edi_usage
                    : false;
            }
            return res;
        },
        export_as_JSON: function () {
            ...
            res.l10n_mx_edi_usage = this.l10n_mx_edi_usage
                ? this.l10n_mx_edi_usage
                : false;
            return res;
        },
    ...
    models.PosModel = models.PosModel.extend({
        initialize: function (session, attributes) {
            this.usage_selection = [
                ...
                {
                    id: "D10",
                    name: _t("Payments for educational services (Colegiatura)"),
                },
    ...
    screens.PaymentScreenWidget.include({
        ...
        usage_changed: function () {
            ...
            this.$(".js_usage_name").text(
                usage
                    ? "(" + usage + ")" + this.pos.get_order().get_usage_byid().name
                    : _t("Usage")
            );
        },
    });
    ...
    var UsageListScreenWidget = screens.ScreenWidget.extend({
        ...
        show: function () {
            ...
            this.$(".client-list-contents").delegate(".client-line", "click", function (
                event
            ) {
        ...
        has_usage_changed: function () {
            ...
            return Boolean(this.old_usage) !== Boolean(this.new_usage);
        },
        ...
        render_list: function (usages) {
            ...
            for (var i = 0, len = usages.length; i < len; i++) {
                var usage = usages[i];
                var usageline_html = QWeb.render("UsageLine", {
                    widget: this,
                    usage: usages[i],
                });
