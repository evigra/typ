...
report_sxw.report_sxw('report.lot.stock.refacciones', 'stock.location', 'argil_content_location_filters/report/refacciones.rml', parser=lot_overview,header='internal')
