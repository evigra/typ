...
report_sxw.report_sxw(
    'report.formal_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/formal_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
report_sxw.report_sxw(
    'report.supplier_formal_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/supplier_formal_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
report_sxw.report_sxw(
    'report.detail_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/detail_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
report_sxw.report_sxw(
    'report.supplier_detail_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/supplier_detail_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
report_sxw.report_sxw(
    'report.aging_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/aging_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
report_sxw.report_sxw(
    'report.supplier_aging_due_report_typ',
    'res.partner',
    'addons/aging_due_report_typ/report/supplier_aging_due_report_typ.rml',
    parser=aging_parser,
    header=False
)
